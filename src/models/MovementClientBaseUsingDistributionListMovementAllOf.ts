...
export function MovementClientBaseUsingDistributionListMovementAllOfFromJSONTyped(json: any, _ignoreDiscriminator: boolean): MovementClientBaseUsingDistributionListMovementAllOf {
