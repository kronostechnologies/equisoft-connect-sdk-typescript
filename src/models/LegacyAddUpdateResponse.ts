...
import {
    ...
    LegacyAddUpdateResponseAllOfFromJSON,
    LegacyAddUpdateResponseAllOfFromJSONTyped,
    LegacyAddUpdateResponseAllOfToJSON,
    LegacyResponse,
...
export function LegacyAddUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyAddUpdateResponse {
