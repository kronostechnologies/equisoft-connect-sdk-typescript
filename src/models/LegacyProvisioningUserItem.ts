...
import {
    ...
    LegacyProvisioningGroupItemFromJSONTyped,
...
export function LegacyProvisioningUserItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyProvisioningUserItem {
