...
export function LegacyProvisioningGetOrganizationResponseAllOfFromJSONTyped(json: any, _ignoreDiscriminator: boolean): LegacyProvisioningGetOrganizationResponseAllOf {
