...
import {
    ...
    LegacyDocumentDocumentPayloadFromJSONTyped,
...
export function LegacyDocumentDocumentPayloadRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyDocumentDocumentPayloadRequest {
