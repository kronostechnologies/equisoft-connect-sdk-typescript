...
import {
    ...
    LegacyProvisioningUserItemFromJSONTyped,
...
export function LegacyProvisioningOrganizationItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyProvisioningOrganizationItem {
